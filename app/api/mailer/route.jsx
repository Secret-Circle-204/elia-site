...
export async function POST(request) {
  // const username = process.env.NEXT_PUBLIC_BURNER_USERNAME || 'construction@eliayoussefdesigns.com'
  const username = 'construction@eliayoussefdesigns.com'
  const password = 'Elia@0125265431'
  const recipientEmail = 'construction@eliayoussefdesigns.com'
  const recipientEmail2 = 'hamzamode202@gmail.com'
  const myEmail = 'construction@eliayoussefdesigns.com'
  const myEmail2 = 'hamzamode202@gmail.com'
  ...
  console.log('**>>>>>>' + formData.get('name') + formData.get('phone') + formData.get('address') + senderEmail + ' ' + email + ' ' + myEmail + ' ' + myEmail2 + username + ' ' + password)
